...
public class TimeEntryControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        CounterService timeEntryCounter = mock(CounterService.class);
        GaugeService timeEntryGauge = mock(GaugeService.class);
        controller = new TimeEntryController(timeEntryRepository,timeEntryCounter, timeEntryGauge);
    }
